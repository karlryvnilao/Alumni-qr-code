            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="../functions/administrator/add-batch.php" method="post">
                        <div class="form-floating mb-3"><input class="form-control form-control" type="text" name="name" placeholder="Batch Year :" required=""><label class="form-label" for="floatingInput">Batch Year :</label></div>
